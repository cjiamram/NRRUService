...
<?php
	...
	$cnf=new Config();
	$url=$cnf->restURL."tissue/getTaskInprogress.php";
	$api=new ClassAPI();
	...
	if($data!=""){
		...
		echo "<div style='text-align:center'><span style='font-family:tahoma;font-size:18px;font-weight:bold;color:red'>ไม่มีงานที่กำลังดำเนินงาน</span></div>";
	}
?>
