...
<?php
	...
	$cnf=new Config();
	$url=$cnf->restURL."tissue/getTaskInitialize.php";
	$api=new ClassAPI();
	...
	if($data!=""){
		...
		echo "<div style='text-align:center'><span style='font-family:tahoma;font-size:18px;font-weight:bold;color:red'>ไม่มีงานใหม่แจ้งเข้ามา</span></div>";
	}
?>
