...
<div class="wrapper">
            ...
            <a href="#" class="dropdown-toggle" onclick='initialize()' data-toggle="dropdown">
               <?php
                ...
                /*if(isset($_SESSION["Picture"])){
                  if(PageInfo::geURLtStatus($_SESSION["Picture"])!==404)
  ...
  function initialize(){
    $("#dvMain").load("/NRRUServiceOnline/Dashboard/mainDashBoard.php");
    //$("#dvMain").load("/NRRUServiceOnline/tissue/indexNewRequest.php");
